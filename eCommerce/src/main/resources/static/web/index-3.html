...
<div class="main-wrapper">
    ...
    <div class="hero-section section">
        ...
        <div class="hero-slider hero-slider-three fix">
            ...
            <!-- Hero Item Start -->
            <div class="hero-item" style="background-image: url(assets/images/hero/hero-5.jpg)">
				<div class="container">

					<!-- Hero Content -->
					<div class="hero-content-2">

						<h1>Trendy & Hot <br> Baby collection 2022</h1>
						<a href="#">SHOP NOW</a>
            ...
            <!-- Hero Item Start -->
            <div class="hero-item" style="background-image: url(assets/images/hero/hero-6.jpg)">
				<div class="container">
    ...
    <div class="product-section section section-padding">
        <div class="container">
            ...
            <div class="row">
				<ul class="product-tab-list nav col mb-30">
				  <li><a class="active" data-bs-toggle="tab" href="#product-new">New</a></li>
				  <li><a data-bs-toggle="tab" href="#product-popular">Popular</a></li>
				  <li><a data-bs-toggle="tab" href="#product-sale">Sale</a></li>
				</ul>
            </div>
            ...
            <div class="row">
                <div class="tab-content col-12" id="myTabContent">
					...
					<div class="tab-pane fade" id="product-popular">
						<div class="row mbn-40">
					...
					<div class="tab-pane fade" id="product-sale">
						<div class="row mbn-40">
    ...
    <div class="banner-section section section-padding pt-0">
        <div class="container">
    ...
    <div class="product-section section section-padding pt-0">
        <div class="container">
			...
			<div class="product-slider slick-space">
    ...
    <!-- Deal Section Start -->
    <div class="deal-section section section-padding pt-0">
        <div class="container">
			<div class="deal-product-slider pb-30">
				<div class="deal-product mbn-30">
					<div class="image col-md-4 col-12 mb-30"><img src="assets/images/product/deal-1.png" alt="Image"></div>
					<div class="content col-md-6 col-12 mb-30">
						<h2 class="title"><a href="single-product.html">2 Piece Shirt Set</a></h2>
						<span class="price">$13 <span class="old">$28</span></span>
						<div class="countdown" data-countdown="2023/06/20"></div>
						<a class="shop-now-link" href="single-product.html" data-hover="SHOP NOW">SHOP NOW</a>
					</div>
				</div>
				<div class="deal-product mbn-30">
					<div class="image col-md-4 col-12 mb-30"><img src="assets/images/product/deal-2.png" alt="Image"></div>
					<div class="content col-md-6 col-12 mb-30">
						<h2 class="title"><a href="single-product.html">Kelly Shirt Set</a></h2>
    ...
    </div><!-- Deal Section End -->
    
    <!-- Feature Section Start -->
    <div class="feature-section section section-padding pt-0">
        <div class="container">
            <div class="feature-wrap row row-10 mbn-20">

                <div class="col-lg-4 col-md-6 col-12 mb-20">
                    <div class="feature-item-2 text-center bg-theme-two" style="background-image: url(assets/images/feature/feature-1-bg.png)">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-20">
                    <div class="feature-item-2 text-center bg-theme-two" style="background-image: url(assets/images/feature/feature-2-bg.png)">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-20">
                    <div class="feature-item-2 text-center bg-theme-two" style="background-image: url(assets/images/feature/feature-3-bg.png)">
                ...
                <div class="col-lg-6 col-12 mb-40">
                    <div class="blog-item">
                        <div class="image-wrap">
                            ...
                            <a class="image" href="single-blog.html"><img src="assets/images/blog/blog-3.jpg" alt="Image"></a>
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-6 col-12 mb-40">
                    <div class="blog-item">
                        <div class="image-wrap">
                            ...
                            <a class="image" href="single-blog.html"><img src="assets/images/blog/blog-4.jpg" alt="Image"></a>
                        </div>
                        <div class="content">
